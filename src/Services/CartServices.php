...
class CartServices{
    ...
    public function getFullCart(){
        ...
        $fullCart['data'] = [
           ...
           "subTotalHT" =>$subTotal,
           "TPS" => round($subTotal*$this->TPS,2),
           "TVQ" => round($subTotal*$this->TVQ,2),
           "subTotalTTC" =>round(($subTotal + $subTotal * $this->TPS + $subTotal*$this->TVQ),2)
        ];
        return $fullCart;
